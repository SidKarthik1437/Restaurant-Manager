...
const AdminEAP = () => {
    ...
    const isInvalid = admin_password1 === "" || admin_password2 === "" || admin_email === "";
    ...
    const handleSignUp = async (event) => {''
      ...
      if(admin_password1 === admin_password2){
          try{
              const createdUser = await firebase.auth().createUserWithEmailAndPassword(admin_email, admin_password2);
        ...
        >
            ...
            >
                ...
                <input
                    ...
                    placeholder="name"
                    name="name"
                    className="rounded-xl w-80 h-10 text-lg select-none text-background-sidebar   shadow-neu-admin-input placeholder-opacity-50 "
                ...
                <div>
                    <Link to={Routes.SIGNUP_HELLO}>
                        ...
                        <button
                            type="submit"
                            disabled={isInvalid}
                            className={`w-40 h-10 mx-10 text-blue-nav-full bg-background-sidebar rounded-xl text-center text-xl ${isInvalid && `opacity-50`}`}
                        >
                            next
                        </button>
                </div>
    ...
    return (
        ...
        >
            <div className="mt-10">
                ...
                <form onSubmit={handleInput} method="POST" autoComplete='on'
                ...
                <AnimatePresence exitBeforeEnter>
                    <Switch location={location} key={location.pathname}>
                        <Route
                            ...
                            component={Profile}
                        />
                        <Route path={Routes.SIGNUP_ADMIN} component={AdminEAP} />
